...
function Aboutus() {
  return (
    <div className=' bg-[#f3f3f3] md:pt-16 pb-16 pt-8 w-full px-8 md:px-32 mx-auto' >
        <h1 className='text-4xl py-4 text-green-600 text-left font-bold'>About The Institute</h1>
...
The Institute has its focus on quality and rigorous education, quality resource, academic infrastructure, technology and innovation. These initiatives have helped IIIT-Bhubaneswar achieve pre-eminence in India and beyond. </div>
